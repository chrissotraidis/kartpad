...
Open-issue audit: 19 open issues and four open PRs checked during the 08:46 UTC cycle on 9 September 2026.
...
| PR #112 controller/keyboard work | Contributor changes requested | Manual owner prepared follow-up 8e14158 for cancellation and physical-scancode mapping, with native regression evidence. Contributor PR head remains d18d3e6; review/integration and owner/Retro gameplay acceptance still needed | macOS; owner/Retro acceptance pending |
...
| #100 external displays | [Draft PR #156](https://github.com/chrissotraidis/kartpad/pull/156) corrects Metal-view ownership; manual owner has physical probe evidence | Native helper recreation/presentation tests pass including physical M2 iPad probe per owner; full-game surface-loss/touch and external output acceptance remain | iPhone/iPad and Android separately; wired first, then wireless |
| Report context/provenance | Android reviewed-log flow has local physical evidence; Apple draft PR159 adds attachment instructions | Independent source review of PR159 at8c75d61 finds no blocker in its narrow changes, but reviewed-log acknowledgement/inability path is absent. Apple owner retains this next-IPA requirement; instruction text alone is not parity | Android and iPhone/iPad; physical Apple share tests remain |
