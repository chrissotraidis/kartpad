...
| #135 iPad launch crash | M2-targeted initializer instruction verified; baseline CPU correction independently reviewed | [0.4.13 build 29 published](releases/v0.4.13-ios.1.md) by the manual owner; exact-build A10X confirmation and original crash PC/binary UUID still needed | A10X/iPadOS report; declared minOS alone is not device acceptance |
