...
Open-issue audit: 19 open issues and PR #112 checked during the 05:28 UTC cycle on 9 September 2026.
...
| Report context/provenance | PR #133 merged; Android preview released; local Android code35 report-evidence flow under manual owner | [iPhone/iPad build 29 published](releases/v0.4.13-ios.1.md); physical report/share tests remain pending | Android and iPhone/iPad; physical Apple share tests remain |
