...
| PR #112 controller/keyboard work | Contributor changes requested | Manual owner prepared follow-up 8e14158 for cancellation and physical-scancode mapping, with native regression evidence; independent Medium source review and existing focused binary rerun cleared the correction. Contributor head0b4153f fixes Cancel/close/Escape, but independent delta review still finds tab/focus capture leakage and incomplete ISO/JIS mapping; follow-up posted. Prepared8e14158 covers these cases; final integration and owner/Retro gameplay acceptance remain | macOS; owner/Retro acceptance pending |
