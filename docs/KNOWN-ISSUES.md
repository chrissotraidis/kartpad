...
| --- | --- |
| [#166](https://github.com/chrissotraidis/kartpad/issues/166) HONOR graphics corruption | YLE-W09, Android16/API36, exact preview1/build28, Original/base,1x Fill Screen, validation ON; report KP-13D4AF72. Seven image attachments supplied but coordinator viewer could not fetch them. Reviewed GPU/driver and actual-draw/error text requested; GPU and shared root cause not inferred. |
| [#167](https://github.com/chrissotraidis/kartpad/issues/167) Helio G200 performance | Reporter identifies Infinix Hot60Pro, Android16/XOS16.3, HelioG200/MaliG57MC2/8GB and0.4.11Original; reports15–20FPS gameplay/~30menus versus Dolphin50–60FPS. Existing resolution/aspect requested to clarify 'default'; no repeat benchmark. No hardware acceptance or shared-cause claim from other-device measurements. |
