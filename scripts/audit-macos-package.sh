...
test "$(plutil -extract CFBundleShortVersionString raw "${plist}")" = "${KARTPAD_EXPECTED_VERSION:-0.4.11}"
test "$(plutil -extract CFBundleVersion raw "${plist}")" = "${KARTPAD_EXPECTED_BUILD_NUMBER:-26}"
